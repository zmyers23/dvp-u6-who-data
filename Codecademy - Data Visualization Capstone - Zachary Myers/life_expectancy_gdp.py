...
The range is much greater in the GDP graph than in the LEABY graph.
...
China has the greatest change in GDP, and Zimbabwe has the greatest change in LEABY.
Mid-2000s (2006-2009) have the greatest changes in data.
Zimbabwe has had the least change in GDP over time.
Changes in GDP are significantly different between countries. Changes in LEABY are similar for all countries except Zimbabwe.
GDP and life expectancy are not necessarily correlated.
Economic growth from expanding industries, and increased LEABY from improvements to healthcare and sanitation.
...
China
Zimbabwe
No, we saw this in our earlier graphs.
It is difficult to track changes over time across multiple graphs like this. A line graph sounds like a great idea!
...
United States of America has the highest GDP. Zimbabwe has the lowest GDP.
...
Germany has the higest life expectancy. Zimbabwe has the lowest life expectancy.
...
get_ipython().set_next_input('What happened in Zimbabwe between 2000 and 2015 that caused a dip, followed by a rise in life expectancy');get_ipython().magic('pinfo expectancy')

An economic meltdown caused the initial dip in life expectancy at the beginning of the century. 
The unification of political parties in the first decade of this century improved the economy, making food and healthcare more readily available.

Source: Murwirapachena, G. & Mlambo, C. "Life Expectancy in Zimbabwe: An Analysis of Five Decades". International Business & Economics Research Journal 14, 3: 2015.
